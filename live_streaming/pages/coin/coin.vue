	...
	<view class="border-top border-light-secondary p-3">
		...
		<view class="border-top border-light-secondary my-3"></view>
			...
			<view class="position-fixed left-0 bottom-0 right-0 border-top flex px-3 align-center" style="height: 100rpx;">
				...
				<view class="bg-main rounded flex align-center justify-center ml-auto"
			...
			<uni-popup ref="popup" type="dialog">
				<uni-popup-dialog mode="input" message="自定义充值"
				 :duration="2000" placeholder="充值金额" inputType="number" :before-close="true"
				@click="close" @confirm="confirm" ></uni-popup-dialog>
			</uni-popup>
		</view>
