...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _fGift = _interopRequireDefault(__webpack_require__(/*! @/components/live/f-gift.vue */ 10));\nvar _fDanmu = _interopRequireDefault(__webpack_require__(/*! @/components/live/f-danmu.vue */ 16));\nvar _uniPopup = _interopRequireDefault(__webpack_require__(/*! @/components/uni-ui/uni-popup/uni-popup.vue */ 21));\nvar _gift = _interopRequireDefault(__webpack_require__(/*! @/common/gift.js */ 52));\nvar _request = _interopRequireDefault(__webpack_require__(/*! @/common/request.js */ 53));\nvar _config = _interopRequireDefault(__webpack_require__(/*! @/common/config.js */ 54));\nvar _vuex = __webpack_require__(/*! vuex */ 55);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var _default =\n\n{\n  components: {\n    fGift: _fGift.default,\n    fDanmu: _fDanmu.default,\n    uniPopup: _uniPopup.default,\n    myGifts: _gift.default },\n\n  data: function data() {\n    return {\n      statusBarHeight: 0,\n      content: \"\",\n      gifts: [],\n      giftActiveId: 0,\n      id: 0,\n      sign: \"\",\n      list: [],\n      detail: {\n        create_time: \"\",\n        id: 1,\n        title: \"\",\n        cover: \"\",\n        user_id: 0,\n        look_count: 0,\n        coin: 0,\n        key: \"\",\n        status: 0,\n        userId: 0,\n        user: {\n          id: 0,\n          username: \"\",\n          avatar: \"\" } } };\n\n\n\n  },\n  methods: {\n    //处理直播间事件\n    handleLiveEvent: function handleLiveEvent(e) {\n      var d = e.data;\n      switch (e.type) {\n        case \"online\":\n          if (d.action === \"join\") {\n            this.list = d.data;\n          }\n          if (d.action === \"leave\") {\n            this.list = d.data;\n          }\n          break;\n        case 'comment':\n          this.$refs.danmu.send({\n            id: d.id,\n            name: d.user.name,\n            content: d.content });\n\n          this.content = '';\n          this.$refs.input.close();\n          break;\n        case 'gift':\n          this.$refs.gift.send({\n            username: d.username,\n            avatar: d.avatar,\n            gift_name: d.gift_name,\n            gift_image: d.gift_image,\n            num: d.num });\n\n        default:\n          break;}\n\n    },\n    //加入或离开直播间\n    joinOrLeaveLive: function joinOrLeaveLive(type) {\n      if (this.socket && this.token) {\n        this.socket.emit(type + \"Live\", {\n          live_id: this.id,\n          token: this.token });\n\n      }\n    },\n    //打开输入弹幕的对话框\n    openInput: function openInput() {\n      // store.dispatch('authMethod',() => {\n      // \tthis.$refs.input.open();\n      // })\n      this.$store.dispatch(\"authMethod\", this.$refs.input.open());\n    },\n    openGift: function openGift() {\n      this.$refs.giftPopup.open();\n    },\n    closeGift: function closeGift() {\n      this.$refs.giftPopup.close();\n    },\n    sendGift: function sendGift() {var _this = this;\n      if (this.giftActiveId === 0) {\n        return uni.showToast({\n          title: \"请选择要发送的礼物\",\n          icon: \"none\" });\n\n      }\n      var index = this.gifts.findIndex(function (item) {return item.id === _this.giftActiveId;});\n      if (index === -1) {\n        return;\n      }\n      var g = this.gifts[index];\n\n      if (!this.token && !this.socket) {\n        uni.navigateTo({\n          url: '../login/login' });\n\n        return uni.showToast({\n          title: '请先登录',\n          icon: 'none' });\n\n      }\n      __f__(\"log\", \"11111111\", \" at pages/live/live.nvue:235\");\n      __f__(\"log\", g, \" at pages/live/live.nvue:236\");\n      if (this.socket) {\n        __f__(\"log\", \"请求到socket\", \" at pages/live/live.nvue:238\");\n        this.socket.emit('gift', {\n          live_id: this.id,\n          gift_id: g.id,\n          token: this.token });\n\n      }\n      // this.$refs.gift.send({\n      // \tusername: this.$store.state.user.username,\n      // \tavatar: this.$store.state.user.avatar,\n      // \tgift_name: g.name,\n      // \tgift_image: g.image,\n      // \tnum: 10\n      // });\n      this.closeGift();\n    },\n    //提交发送弹幕信息\n    submit: function submit() {\n      if (this.content === \"\") {\n        return uni.showToast({\n          title: '评论内容不能为空',\n          icon: 'none' });\n\n      }\n      if (!this.token && !this.socket) {\n        uni.navigateTo({\n          url: '../login/login' });\n\n        return uni.showToast({\n          title: '请先登录',\n          icon: 'none' });\n\n      }\n      // this.$refs.danmu.send({\n      // \tid: Math.random() * 100, //随机生成id\n      // \tname: this.$store.state.user.username,\n      // \tcontent: this.content\n      // });\n      if (this.socket) {\n        __f__(\"log\", \"121213123123213\", \" at pages/live/live.nvue:277\");\n        this.socket.emit('comment', {\n          live_id: this.id,\n          data: this.content,\n          token: this.token });\n\n      }\n      this.content = \"\";\n      this.$refs.input.close();\n    },\n    back: function back() {\n      uni.navigateBack({\n        delta: 1 });\n\n    },\n    openCoin: function openCoin() {\n      uni.navigateTo({\n        url: \"../coin/coin\" });\n\n    },\n    getData: function getData() {\n      // return this.$H.get('/live/read'+id)\n    } },\n\n  mounted: function mounted() {\n    //加入直播间\n    this.joinOrLeaveLive(\"join\");\n    //送礼物演示\n    // setInterval(() => {\n    // \tthis.$refs.gift.send({\n    // \t\tusername: \"发送人\",\n    // \t\tavatar: \"\",\n    // \t\tgift_name: \"蛋糕\",\n    // \t\tgift_image: \"/static/gift/3.png\",\n    // \t\tnum: 1\n    // \t});\n    // }, 3000);\n  },\n  destroyed: function destroyed() {\n    //离开直播间\n    this.joinOrLeaveLive(\"leave\");\n    //移除全局事件\n    uni.$off(\"live\", this.handleLiveEvent);\n  },\n  computed: _objectSpread({\n    src: function src() {\n      if (this.detail.key == \"\" || this.sign == \"\") {\n        return \"\";\n      }\n      return \"https://obss.utools.club/live/\".concat(this.detail.key, \".flv?sign=\").concat(this.sign);\n    } },\n  (0, _vuex.mapState)({\n    socket: function socket(state) {return state.socket;},\n    token: function token(state) {return state.token;} })),\n\n\n  onLoad: function onLoad(option) {var _this2 = this;\n    this.id = option.id;\n    __f__(\"log\", this.id, \" at pages/live/live.nvue:335\");\n    var res = uni.getSystemInfoSync();\n    this.statusBarHeight = res.statusBarHeight;\n    this.gifts = _gift.default;\n    _request.default.get(\"/live/read/\" + this.id).then(function (res) {\n      __f__(\"log\", res, \" at pages/live/live.nvue:340\");\n      _this2.detail = res.data;\n      _this2.sign = res.sign;\n    });\n    //请求礼物列表接口\n    _request.default.get('/gift/list').then(function (res) {\n      _this2.gifts = res.map(function (item) {\n        item.image = '../../static/gift/' + item.image;\n        return item;\n      });\n    });\n    //监听全局事件\n    uni.$on(\"live\", this.handleLiveEvent);\n  } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 9)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///51\n");
...
/* 54 */
/*!*********************************************************************!*\
  !*** D:/dev/uni-app/live_streaming/live_streaming/common/config.js ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;var _default = {\n  baseUrl: \"https://oupai.utools.club\",\n  socketUrl: \"https://oupai.utools.club\" };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///54\n");
